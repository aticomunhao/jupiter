        ...
        <div class="card" style="border-color:#355089">
            ...
            <div class="card-body">
                ...
                <div class="col-md-4 col-sm-12">
                    <input class="form-control" type="text" value="{{ $tp_cargo->nomeTpCargo }}"{{-- Campo com o nome do cargo --}}
                ...
                <div class="col-md-4 col-12">
                    <a href="{{ route('gerenciar.cargos') }}">{{-- Botao de retorno para index --}}
                        <button type="button"
                            class="btn btn-primary col-md-6 col-12 offset-md-5 offset-0 mt-3 mt-md-0">Confirmar</button>
                    </a>
                </div>
            </div>
