        ...
        <div class="justify-content-center">
            <div class="col-12">
                ...
                <div class="card" style="border-color: #355089;">
                    ...
                    <div>
                        <div class="card-body">
                            <form class="justify-content-center" action="{{ route('gerenciar-associado') }}"
                                ...
                                <tr>
                                    ...
                                    <td scope="" style="text-align: center">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-secondary"
                                            data-toggle="modal" data-target="#camera{{ $lista_associados->id }}"><i
                                                class="bi bi-camera" style="font-size: 1rem; color:#303030;"></i></button>
                                        <a href="/capture-photo/{{ $lista_associados->id }}"><button type="button"
                                                class="btn btn-outline-primary btn-sm"><i class="bi-search"
                                                    style="font-size: 1rem; color:#303030;"></i></button></a>

                                                    <a href="{{asset($lista_associados->caminho_foto_associado)}}" class="btn btn-outline-primary btn-sm">
                                                        TESTE
                                                    </a>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="/excluir-associado/{{ $lista_associados->id }}"><button
                                                                    type="button" class="btn btn-danger">Desativar
                                                                    Permanentemente
                                                                </button></a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="modal fade bd-example-modal-lg"
                                            id="camera{{ $lista_associados->id }}" tabindex="-1" role="dialog"
