                ...
                <div>
                    <div class="card-body">
                        <form class="justify-content-center" class="form-horizontal mt-4" method="GET">
                            <div class="row">
                                    <div class="col-lg-2 col-6">Data de Início
                                    <input class="form-control" style="border: 1px solid #999999; padding: 5px;"
                                        maxlength="30" type="date" id="3" name="dt_inicio"
                                        value="{{ $dt_inicio }}">
                                </div>
                                <div class="col-lg-2 col-6">Data de Fim
                                    <input class="form-control" style="border: 1px solid #999999; padding: 5px;"
                                ...
                                <div class="col-lg-2 col-6">Nr Associado
                                    <input class="form-control" style="border: 1px solid #999999; padding: 5px;"
                                        maxlength="50" type="text" id="2" name="nr_associado"
                                        value="{{ $nr_associado }}">
                                </div>                                                                   
                                <div class="col-lg-2 col-6">Status
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-6">
                                    <input class="btn btn-light w-100" formaction="{{ route('pesquisar') }}" style="font-size: 0.9rem; box-shadow: 1px 2px 5px #000000; margin:5px;" type="submit" value="Pesquisar">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <a href="/gerenciar-associado"><button class="btn btn-light w-100" type="button" value=""
                                            style="font-size: 0.9rem; box-shadow: 1px 2px 5px #000000; margin:5px;">Limpar</button></a>
                                </div>
                                </form>
                                <div class="col-lg-2 col-6">
                                    <a href="/informar-dados-associado"><input class="btn btn-success w-100" type="button" name="6" value="Novo Cadastro +"
                                ...
                                <div class="col-lg-2 col-6">                                      
                                    ...
                                    <form method="POST">
                                        @csrf
                                        <input class="btn btn-warning w-100" formaction="{{ route('executar.job') }}" style="font-size: 0.9rem; box-shadow: 1px 2px 5px #000000; margin:5px;" type="submit" value="Importa Assoc">
                                    </form>
                                    @endif
                                </div>
                            </div>
