                ...
                <div class="card-body">
                    <div class="row"> {{-- Linha com o nom--}}
                        ...
                        <div class="col-md-3 offset-md-4 col-12 mt-4 mt-md-0"> {{-- Botão de incluir --}}
                            <a href="{{route('dados-bancarios-associado.insert',['id'=> $associado->ida ])}}" class="col-6"><button type="button" class="btn btn-success col-md-8 col-12">+Novo Cadastro</button></a>
                        </div>
                    </div>
                </div>
                <hr />
