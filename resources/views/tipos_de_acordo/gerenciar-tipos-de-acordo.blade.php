@extends('layouts.app')
@section('head')
    <title>Gerenciar Tipos de Acordo</title>
@endsection
@section('content')
                ...
                <div class="card" style="border-color: #355089;">
                    <div class="card-header">
                        <div class="row justify-content-between">
                            <h5 class="col-md-4 col-sm-12" style="color: #355089">
                                Gerenciar Tipos de Acordo
                            </h5>
                            <div class="col-md-3 col-sm-12">
                                <a href="{{ route('create.tipos-de-acordo') }}"{{-- Botao com rota para incluir entidades --}}
                    ...
                    <table class="table  table-striped table-bordered border-secondary table-hover align-middle">
                        ...
                        <tbody style="font-size: 15px; color:#000000;">
                            @foreach ($tipos_de_acordo as $tipo_de_acordo)
                                {{-- Foreach da tabela com os dados --}}
                                <tr style="text-align: center">
                                    <td>{{ $tipo_de_acordo->nome }}</td> {{-- Variavel que tras os nomes das entidades de ensino --}}
                                    <td>
                                        <a href="{{ route('edit.tipos-de-acordo', ['id' => $tipo_de_acordo->id]) }}"><button
                                        ...
                                        <button type="button"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#A{{ $tipo_de_acordo->id }}"
                                            data-tt="tooltip" data-placement="top" title="Excluir"
                                            style="font-size: 1rem; color:#303030;"><i class="bi bi-trash"></i></button>

                                        <div class="modal fade" id="A{{ $tipo_de_acordo->id }}" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background-color:#DC4C64;">
                                                        <h5 class="modal-title" id="exampleModalLabel"
                                                            style=" color:rgb(255, 255, 255)">Excluir Tipo De Acordo
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        Você realmente deseja excluir <br><span
                                                            style="color:#DC4C64; font-weight: bold">{{ $tipo_de_acordo->nome }}</span>
                                                        ?
                                                    ...
                                                    <div class="modal-footer mt-2">
                                                        ...
                                                        <a type="button" class="btn btn-primary"
                                                            href="{{ route('destroy.tipos-de-acordo', ['id' => $tipo_de_acordo->id]) }}">Confirmar
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
