        ...
        <div class="container">
            ...
            @if(in_array(1, $perfis) or in_array(2, $perfis) or in_array(3, $perfis) or in_array(4, $perfis) or in_array(5, $perfis) or in_array(6, $perfis))
                <ul class="navbar-nav" id="2">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                            <li><a href="{{ route('gerenciar.cargos') }}" class="dropdown-item">Cargo dos Funcionários</a>
                            </li>
                            ...
                            <li><a href="{{ route('index.tipos-de-contrato') }}" class="dropdown-item">Tipos de Contrato</a>
                            </li>
            ...
            @endif
                <ul class="navbar-nav" id="3">
                    <li class="nav-item dropdown">
                        ...
                        data-bs-toggle="dropdown" aria-expanded="false" style="color:#ffffff;">Direitos Remuneratórios</a>
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                            @if (in_array(7, $perfis ?? []))
                                <li><a href="{{ route('IndexGerenciarFerias') }}" class="dropdown-item">Período de Férias</a>
                                </li>
                            @endif
                            ...
                            @if (in_array(3, $perfis ?? []) or in_array(3, $perfis ?? []))
                                <li><a href="{{ route('index.gerenciar-dia-limite-ferias') }}" class="dropdown-item">Dias limite para as Férias </a>
                                </li>
                            @endif
                        </ul>
                    </li>
            ...
            @if(in_array(1, $perfis ?? []) or in_array(6, $perfis ?? []) or in_array(4, $perfis ?? []))
                <ul class="navbar-nav" id="4">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="d" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color:#ffffff;">Relatórios</a>
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                ...
                <ul class="navbar-nav" id="5">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="e" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false" style="color:#ffffff;">Administrar Sistema</a>
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
