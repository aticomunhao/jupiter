                ...
                <form method="post" action="/armazenar-dependentes/{{$funcionario_atual[0]->id}}">
                    ...
                    <div class="row">
                                <div class="d-grid gap-1 col-2 mx-auto">
                                    <a class="btn btn-danger btn-sm" href="/incluir-dependentes/{{$funcionario_atual[0]->id}}" role="button">Limpar</a>
                                </div>
                                <div class="d-grid gap-2 col-2 mx-auto">
                                  <button type="submit" class="btn btn-success btn-sm" id="sucesso" onclick="sucesso()">Confirmar</button>
                                </div>
                    </div>
                    </form>
                </div>
