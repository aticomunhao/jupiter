                ...
                <form method="post" action="/atualizar-dependentes/{{ $dependente->id }}">
                    ...
                    <div class="form-group row">
                        <div class="col-md-2 mt-1 mt-md-0">Parentesco
                            <select class="form-select" id = "{{ $dependente->id_parentesco }}" name="relacao_dep"
                                required="required" value ="{{ $dependente->id_parentesco }}">
                    ...
                    <div class="row">
                        ...
                        <center>
                            <a class="btn btn-danger col-md-3 col-5 mt-5"
                                href="/gerenciar-dependentes/{{ $funcionario->id }}" role="button">Cancelar</a>
