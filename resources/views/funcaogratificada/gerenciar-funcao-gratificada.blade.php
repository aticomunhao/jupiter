                                            ...
                                            @foreach ($funcoesgratificadas as $funcoesgratificada)
                                                @if ($funcoesgratificada->status == false)
                                                    <tr class="text-secondary">
                                                        <td class="align-middle text-danger">
                                                            {{ $funcoesgratificada->nomeFG }}</td>
                                                        <td class="align-middle">
                                                            <span class="text-danger"> R&dollar;
                                                                {{ $funcoesgratificada->salarioFG }}</span>
                                                        </td>
                                                        <td class="align-middle text-danger">
                                                        ...
                                                        <td class="align-middle">
                                                            ...
                                                            <a href="/historico-funcao-gratificada/{{ $funcoesgratificada->id }}"
                                                ...
                                                @else
                                                    <tr>
                                                        ...
                                                        @if ($funcoesgratificada->dt_fimFG != null)
                                                            <td>{{ \Carbon\Carbon::parse($funcoesgratificada->dt_fimFG)->format('d/m/Y') }}
                                                            </td>
                                                        @elseif($funcoesgratificada->dt_fimFG == null)
