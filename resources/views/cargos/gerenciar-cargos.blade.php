                    ...
                    <tbody style="font-size: 15px; color:#000000;">{{-- Inicio body tabela --}}
                        @foreach ($cargo as $cargos)
                            <tr>
                                ...
                                <td style="text-align:center;">{{ number_format($cargos->salario, 2, ',', '.') }}</td>{{-- Adiciona o salario --}}
                                <td style="text-align: center;">
                                    ...
                                    <a href="{{ route('vizualizarHistoricoCargo', ['id' => $cargos->id]) }}" class="btn btn-outline-primary" data-tt="tooltip" data-placement="top" title="Visualizar">
