                                ...
                                <tr>
                                    @foreach ($lista_setor as $lista_setores)
                                        ...
                                        <td scope="" style="text-align: center">
                                            ...
                                            <a href="/editar-setor/{{ $lista_setores->ids }}"><button type="button"
                                                    class="btn btn-outline-warning"><i class="bi-pencil"
                                                        style="font-size: 1rem; color:#303030;"></i></button></a>
                                            <a href="/carregar-dados/{{ $lista_setores->ids }}"><button type="button"
                                                    class="btn btn-outline-primary"><i class="bi bi-arrow-left-right"
                                                        style="font-size: 1rem;color:#303030; "></i></button></a>
