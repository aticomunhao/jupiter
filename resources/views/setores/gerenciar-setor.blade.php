                    ...
                    <tr>
                        ...
                        <td scope="">
                            <center>
                                ...
                                <a href="/carregar-dados/{{ $listas->ids}}"><button type="button" class="btn btn-outline-primary btn-sm"><i  class="bi bi-arrow-left-right" style="font-size: 1rem;color:#303030; "></i></button></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="/excluir-setor/{{ $listas->ids }}/{{ $listas->ids }}"><button type="button" class="btn btn-primary">Confirmar</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
