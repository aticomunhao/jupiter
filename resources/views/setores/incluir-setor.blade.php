        ...
        <form method = 'POST' action = "/incluir-setores">
            ...
            <div class="form-group row"
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control" name= "nome" maxlength="60" maxlength="45"
                        oninput="this.value = this.value.replace(/[0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                        id="1" value ="">
                </div>
                <div class="form-group col-md-2" style="padding-right:80px">
                    <label for="2">Sigla</label>
                    <input type="text" class="form-control" name = "sigla" maxlength="45"
                        oninput="this.value = this.value.replace(/[0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                        id="2" value ="">
                </div>
                ...
                justify-content:space-between center">
                    ...
                    <div class="form-group col-md-2" style="padding-right:45px">
                        ...
                        <input type="text" class="form-control" name = "nome_subsetor" maxlength="45"
                            oninput="this.value = this.value.replace(/[0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                            id="2" value ="">
                    </div>
                    ...
                    justify-content:space-between; width: 100%;">
                        <div class="form-group col-md-6" style="padding-right: 5%">
                            ...
                            <input type="text" class="form-control" name = "usuario" maxlength="45"
                                oninput="this.value = this.value.replace(/[0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                id="2" value ="">
