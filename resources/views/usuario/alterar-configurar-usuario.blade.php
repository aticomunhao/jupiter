                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal mt-4" method="POST"
                            action="/usuario-atualizar/{{ $resultUsuario[0]->id }}">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped mb-0">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" id="ativo" name="ativo" switch="bool"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" id="bloqueado" name="bloqueado" switch="bool"
            ...
            <div class="col-lg-6">
                <div class="card">
                                ...
                                <table class="table table-bordered table-striped mb-0">
                                    @foreach ($resultPerfil as $resultPerfils)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" id="{{ $resultPerfils->nome }}"
                                ...
                                <table class="table table-bordered table-striped mb-0">
                                    @foreach ($resultDeposito as $resultDepositos)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" id="{{ $resultDepositos->nome }}"
                                                    name="{{ $resultDepositos->nome }}" value="{{ $resultDepositos->id }}"
                                                    {{ in_array($resultDepositos->id, $resultDepositoUsuarioArray) ? 'checked' : '' }}>
                                            </td>
                                        </tr>
                                    @endforeach
                                </table>
                    ...
                    <div class="row justify-content-between">
                        <div class="col">
                            <a href="/gerenciar-usuario"><input class="btn btn-danger btn-block" type="button"
                                    value="Cancelar">
                            </a>
                        </div>
                        <div class="col">
