                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <a href="/usuario-incluir"><input class="btn btn-success btn-sm me-md-2"
                                    style="font-size: 0.9rem;" type="button" value="Incluir Usuário"></a>
                        </div>
                    </div>
                </div>
                <hr />
                                    ...
                                    <tbody>
                                        @foreach ($result as $results)
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($results->data_ativacao)->format('d/m/Y') }}
                                                </td>
                                                <td>
