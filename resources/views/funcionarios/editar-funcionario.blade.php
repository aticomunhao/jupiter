                                    ...
                                    <div class="form-group row"
                                        ...
                                        <div class="form-group row"
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <select id="13" name="cor" class="form-select"
                                                    type="bigint">
                                        ...
                                        <div class="form-group row"
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" class="form-control" name="titele"
                                                    name="matricula" maxlength="12"
                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="date" class="form-control" name="dt_titulo"
                                                    id="18" value="{{ $editar[0]->dt_titulo }}">
                                                <div class="invalid-feedback">
                                                    Por favor, selecione a Data de Emissão.
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row"
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="date" class="form-control" name="dt_ctps"
                                                        id="22" value="{{ $editar[0]->dt_emissao_ctps }}">
                                                    <div class="invalid-feedback">
                                                        Por favor, selecione a Data de Emissão.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <select id="validationCustomUsername" class="form-select"
                                                            name="cnh">
                                                ...
                                                <div>
                                                    <div class="botões">
                                                        ...
                                                        <input type="submit" value="Confirmar"
                                                            class="btn btn-primary col-md-3 col-1 mt-4 offset-md-3">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
