...
@section('content')
    <form class="form-horizontal" method="post" action="/visualizar-funcionario/{{ $pessoa[0]->idp }}">
        @csrf
                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-4 col-sm-12">UF
                                    ...
                                    <select class="js-example-responsive form-select"
                                        style="border: 1px solid #999999; padding: 5px;" id="iduf" name="uf_end" disabled>
