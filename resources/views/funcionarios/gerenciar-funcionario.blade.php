                                ...
                                <div class="row">
                                    <div class="col-2">CPF
                                        <input class="form-control" style="border: 1px solid #999999; padding: 5px;"
                                               maxlength="11" type="text" id="1"
                                               name="cpf" value="{{ $cpf }}">
                                    </div>
                                    <div class="col-2">Identidade
                                        <input class="form-control" style="border: 1px solid #999999; padding: 5px;"
                                               maxlength="9" type="text" id="2"
                                               name="idt" value="{{ $idt }}">
                                    </div>
                                    <div class="col-2">Nome
                                        <input class="form-control" style="border: 1px solid #999999; padding: 5px;"
                                               maxlength="50" type="text" id="3"
                                ...
                                <tr>
                                    ...
                                    <td scope="" style="text-align: center">
                                        ...
                                        <a href="/gerenciar-base-salarial/{{ $listas->idf }}">
                                            <button type="button"
                                                    class="btn btn-outline-primary" data-tt="tooltip"
                                                    data-placement="top" title="Base Salarial"><i class="bi bi-currency-dollar"
                                                                                       style="font-size: 1rem; color:#303030;"></i>
                                            </button>
                                        </a>
                                        ...
                                        <button type="button" class="btn btn-outline-danger"
                                                ...
                                                class="bi-trash" style="font-size: 1rem; color:#303030;" data-tt="tooltip"
