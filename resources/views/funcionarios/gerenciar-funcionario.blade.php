                    ...
                    <div>
                        <div class="card-body">
                            <form action="{{ route('gerenciar') }}" class="form-horizontal mt-2" method="GET">
                                <div class="row">
                                    <div class="col-2">CPF
                                        <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="11" type="text" id="1"
                                            name="cpf" value="{{ $cpf }}">
                                    </div>
                                    <div class="col-2">Identidade
                                        <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="9" type="text" id="2"
                                            name="idt" value="{{ $idt }}">
                                    </div>
                                    <div class="col-2">Nome
                                        <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="50" type="text" id="3"
                                            name="nome"value="{{ $nome }}">
                                    </div>
                                    <div class="col-2">Situação
                                        <select class="form-select custom-select" style="border: 1px solid #999999; padding: 5px;" id="4" name="status"
                                ...
                                @foreach ($lista as $listas)
                                    <tr>
                                        ...
                                        <td scope="" style="text-align: center">
                                            ...
                                            <a href="/pessoas-funcionario/{{ $listas->idf }}"><button type="button"
                                                    class="btn btn-outline-primary"><i class="bi-search"
                                                        style="font-size: 1rem; color:#303030;"></i></button></a>
                                            <a href="/gerenciar-dependentes/{{ $listas->idf }}"><button type="button"
                                                    class="btn btn-outline-primary"><i class="bi-people-fill"
                                                        style="font-size: 1rem;color:#303030; "></i></button></a>
                                            <a href="/gerenciar-dados-bancarios/{{ $listas->idf }}"><button type="button"
                                                    class="btn btn-outline-primary"><i class="bi bi-bank"
                                                        style="font-size: 1rem; color:#303030;"></i></button></a>
                                            <a href="/gerenciar-afastamentos/{{ $listas->idf }}"><button type="button"
                                                    class="btn btn-outline-primary"><i class="bi-bandaid"
                                                        style="font-size: 1rem;color:#303030;"></i></button></a>
                                            <a href="/gerenciar-certificados/{{ $listas->idf }}"><button type="button"
                                                    class="btn btn-outline-primary"><i class="bi-mortarboard"
                                                        style="font-size: 1rem; color:#303030;"></i></button></a>
                                            <a href="/gerenciar-acordos/{{ $listas->idf }}"><button type="button"
                                                    class="btn btn-outline-primary"><i class="bi bi-pencil-square"
                                                        style="font-size: 1rem; color:#303030;"></i></button></a>
                                            <a href="/gerenciar-base-salarial/{{ $listas->idf }}"><button type="button"
                                                    class="btn btn-outline-primary"><i class="bi bi-currency-dollar"
                                                        style="font-size: 1rem; color:#303030;"></i></button></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="/excluir-funcionario/{{ $listas->idf }}"><button
                                                                    type="button"
