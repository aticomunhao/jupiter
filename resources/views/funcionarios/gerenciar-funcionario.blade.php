                    ...
                    <div>
                        <div class="card-body">
                            <form action="{{ route('gerenciar') }}" class="form-horizontal mt-4" method="GET">
                                <div class="row">
                                    <div class="col-2">CPF
                                        <input class="form-control" maxlength="11" type="text" id="1"
                                            name="cpf" value="{{ $cpf }}">
                                    </div>
                                    ...
                                    <div class="col-2">Situação
                                        <select class="form-select custom-select" id="4" name="status"
                                            ...
                                            <td scope="" style="text-align: center">
                                                ...
                                                <a href="/gerenciar-dependentes/{{ $listas->idf }}"><button type="button"
                                                        class="btn btn-outline-primary"><i class="bi-people-fill"
                                                            style="font-size: 1rem;color:#303030; "></i></button></a>
                                                <a href="/gerenciar-dados-bancarios/{{ $listas->idf }}"><button
                                                        type="button" class="btn btn-outline-primary"><i class="bi bi-bank"
                                                            style="font-size: 1rem; color:#303030;"></i></button></a>
                                                <a href="/gerenciar-afastamentos/{{ $listas->idf }}"><button
                                                        type="button" class="btn btn-outline-primary"><i
                                                            class="bi-bandaid"
                                                            style="font-size: 1rem;color:#303030;"></i></button></a>
                                                <a href="/gerenciar-certificados/{{ $listas->idf }}"><button
                                                        type="button" class="btn btn-outline-primary"><i
                                                ...
                                                <a href="/gerenciar-acordos/{{ $listas->idf }}"><button type="button"
                                                        class="btn btn-outline-primary"><i class="bi bi-pencil-square"
                                                            style="font-size: 1rem; color:#303030;"></i></button></a>
                                                <a href="/gerenciar-base-salarial/{{ $listas->idf }}"><button
                                                        type="button" class="btn btn-outline-primary"><i
