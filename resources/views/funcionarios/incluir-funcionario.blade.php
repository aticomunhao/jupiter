                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2 col-sm-12">Matrícula
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" type="numeric" maxlength="11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="1" name="matricula" value="{{ old('matricula') }}" required="required">
                            </div>
                            <div class="col-md-3 col-sm-12">Data Início
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" type="date" id="13" name="dt_ini" value="{{ old('dt_ini') }}" required="required">
                            </div>
                            <div class="col-md-4 col-sm-12">Nome completo
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" type="text" maxlength="45" oninput="this.value = this.value.replace(/[0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="idnome_completo" name="nome_completo" value="{{ old('nome_completo') }}" required="required">
                            </div>
                            <div class="col-md-3 col-sm-12">Data nascimento
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" type="date" value="{{ old('dt_nascimento') }}" id="3" name="dt_nascimento" required="required">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">Nacionalidade
                                <select class="form-select" style="border: 1px solid #999999; padding: 5px;" id="nacionalidade" name="pais" value="{{ old('pais') }}" required="required">
                                    <option value=""></option>
                                    @foreach ($nac as $nacs)
                            ...
                            <div class="col-md-4 col-sm-12">Naturalidade
                                <select class="form-select" id="cidade1" name="natura" value="{{ old('natura') }}" required="required" disabled>
                                </select>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-3 col-sm-12">CPF
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" type="numeric" maxlength="11" placeholder="888.888.888-88" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="8" name="cpf" required="required">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-12">Nr PIS ou PASEP
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="11" type="numeric" id="10" name="nr_programa" value="{{ old('nr_programa') }}" required="required">
                            </div>
                            <div class="col-md-4 col-sm-12">Identidade
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="11" type="numeric" id="11" name="identidade" value="{{ old('identidade') }}" required="required">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-2 col-sm-12">UF
                                <select class="js-example-responsive form-select" style="border: 1px solid #999999; padding: 5px;" id="uf-idt" name="uf_idt" required="required">
                                    <option value=""></option>
                                    @foreach ($tp_uf as $tp_ufs)
                            ...
                            <div class="col-md-2 col-sm-12">Órgão expedidor
                                <select class="form-select" style="border: 1px solid #999999; padding: 5px;" required="required" id="12" name="orgexp" required="required">
                                    <option value=""></option>
                                    <@foreach ($org_exp as $org_exps) <option @if (old('orgexp')==$org_exps->id) {{ 'selected="selected"' }} @endif
                            ...
                            <div class="col-md-2 col-sm-12">Data emissão
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" type="date" id="13" name="dt_idt" value="{{ old('dt_idt') }}" required="required">
                            </div>
                            <div class="col-md-2 col-sm-12">Cor pele
                                <select class="form-select" style="border: 1px solid #999999; padding: 5px;" id="14" name="cor" required="required">
                                    <option value=""></option>
                                    <@foreach ($cor as $cors) <option @if (old('cor')==$cors->id) {{ 'selected="selected"' }} @endif
                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-12">Título eleitor
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="12" type="numeric" id="17" name="titele" value="{{ old('titele') }}">
                            </div>
                            <div class="col-md-2 col-sm-12">Zona
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="5" type="numeric" id="18" name="zona" value="{{ old('zona') }}">
                            </div>
                            <div class="col-md-1 col-sm-12">Seção
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="5" type="numeric" id="19" name="secao" value="{{ old('secao') }}">
                            </div>
                            <div class="col-md-3 col-sm-12">Data emissão
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" type="date" id="20" name="dt_titulo" value="{{ old('dt_titulo') }}">
                            </div>
                            <div class="col-md-2 col-sm-12">DDD
                                <select class="form-select" style="border: 1px solid #999999; padding: 5px;" id="16" name="ddd" required="required">
                                    <option value=""></option>
                                    <@foreach ($ddd as $ddds) <option @if (old('ddd')==$ddds->id) {{ 'selected="selected"' }} @endif
                            ...
                            <div class="col-md-2 col-sm-12">Celular
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="9" type="numeric" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="Ex.: 99999-9999" value="{{ old('celular') }}" id="22" name="celular">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-2 col-sm-12">CTPS
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="8" type="numeric" id="23" name="ctps" value="{{ old('ctps') }}" required="required">
                            </div>
                            <div class="col-md-2 col-sm-12">Série
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="5" type="numeric" id="26" name="serie_ctps" value="{{ old('serie_ctps') }}" required="required">
                            </div>
                            <div class="col-md-2 col-sm-12">UF
                                <select class="js-example-responsive form-select" style="border: 1px solid #999999; padding: 5px;" required="required" id="uf_ctps" name="uf_ctps" required="required">
                                    <option value=""></option>
                                    @foreach ($tp_uf as $tp_ufs)
                            ...
                            <div class="col-md-3 col-sm-12">Data emissão
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" type="date" id="24" name="dt_ctps" value="{{ old('dt_ctps') }}" required="required">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-10">E-mail
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="45" type="email" id="31" name="email" value="{{ old('email') }}">
                            </div>
                            <div class="col-md-2 col-sm-12">Setor
                                <select class="js-example-responsive form-select" style="border: 1px solid #999999; padding: 5px;" required="required" id="setor" name="setor" required="required">
                                    <option value=""></option>
                    ...
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-md-4 col-sm-12">CEP
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="8" type="numeric" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="35" name="cep" value="{{ old('cep') }}">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-12">Logradouro
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="45" type="text" id="36" name="logradouro" value="{{ old('logradouro') }}">
                            </div>
                            <div class="col-md-3 col-sm-12">Número
                                <input class="form-control" style="border: 1px solid #999999; padding: 5px;" maxlength="10" type="text" id="35" name="numero" value="{{ old('numero') }}">
                            </div>
                            <div class="col-md-3 col-sm-12">Complemento
                                <input type="text" style="border: 1px solid #999999; padding: 5px;" maxlength="45" class="form-control" id="36" name="comple" value="{{ old('comple') }}">
                            </div>
                            <div class="col-md-3 col-sm-12">Bairro:
                                <input type="text" style="border: 1px solid #999999; padding: 5px;" maxlength="45" class="form-control" id="36" name="bairro" value="{{ old('bairro') }}">
                            </div>
                        </div>
                    </div>
                </div>
